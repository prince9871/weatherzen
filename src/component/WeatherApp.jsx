...
import { AppBar, Toolbar, Typography, Container, Button, Card, CardContent, Grid, Switch, FormControlLabel } from '@mui/material';
...
const WeatherApp = () => {
  ...
  const fetchWeather = (unit) => {
    ...
    console.log('Request URL:', URL); // Debugging line to check URL
